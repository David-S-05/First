...
public class Lab10 {
    ...
    public static void Q1() {
        while (true) {
            ...
            if (input.equals("square")) {
                ...
                System.out.println("The circumference of the square is: " + a * 4 + "and the area is" + a * a);
                // System.out.println("The area of the square is: " + a * a); Shortened each down to one print statement
                ...
                System.out.println("The circumference of the rectangle is: " + (2 * a + 2 * b) "and the area is" + (a *b));
               // System.out.println("The area of the rectangle is: " + (a * b));Shortened each down to one print statement
            } else if (input.equals("circle")) {
                double r;
                System.out.println("Enter the radius: ");
                r = Double.parseDouble(scan.nextLine());
                System.out.println("The circumference of the circle is: " + (Math.PI * r * 2) + "and the area is" + (Math.PI *r *r));
                //System.out.println("The area of the circle is: " + (Math.PI * r * r));Shortened each down to one print statement
            }
        }
    }
    ...
    public static void Q2() {
        ...
        else if (num == 2 or num == 22){
            String ending = new String("nd");
        }
        else if (num == 3 or num == 23){
            String ending = new String("rd");
        }
        else if (num > 0 and num < 31){
            String ending = new Strin ("th");
        }
        else {
            System.out.println("Invalid day");
        }

        //Condensed down from 31 if/else to 5
        ...
        if(num2 == 1) {
            System.out.println("You selected" + num + ending +"January");
        } else if (num2 == 2) {
            System.out.println("You selected" + num + ending +"February");
        } else if (num2 == 3) {
            System.out.println("You selected" + num + ending +"March");
        } else if (num2 == 4) {
            System.out.println("You selected" + num + ending +"April");
        } else if (num2 == 5) {
            System.out.println("You selected" + num + ending +"May");
        } else if (num2 == 6) {
            System.out.println("You selected" + num + ending +"June");
        } else if (num2 == 7) {
            System.out.println("You selected" + num + ending +"July");
        } else if (num2 == 8) {
            System.out.println("You selected" + num + ending +"Augst");
        } else if (num2 == 9) {
            System.out.println("You selected" + num + ending +"September");
        } else if (num2 == 10) {
            System.out.println("You selected" + num + ending +"October");
        } else if (num2 == 11) {
            System.out.println("You selected" + num + ending +"November");
        } else if (num2 == 12) {
            System.out.println("You selected" + num + ending +"December");
        } else {
            System.out.println("Invalid month");
        }

        //Changed to print both the day and month in one statement
    ...
    public static void Q3() {
        ...
        int enemyHP = 100;
        int attack = 0; //Renamed
        int buff = 0; //Added for buffs/debuffs
        int enemyArmor = 12; //To chang enemy AC
        int critChance = 19; //To change the lowest value needed to criy
        ...
        while (true) {
            ...
            while (!check2) {
                ...
                switch (next) {
                    ...
                    case "B", "b":
                        check = true;
                        System.out.println("Buffing!" + buff + " to your next attack roll and damage"); //Changed to use new variables
                        break;
                    default:
            ...
            if (doAttack) {
                ...
                if(check) {
                    attackRoll += 5;
                    System.out.print(" + buff + (buff active)\n"); //Changed to use new variables
                } else {
                    System.out.println();
                }
                if (attackRoll >= enemyArmor) {//Changed to use new variables
                    damage = rng.nextInt(8) + 1;
                    damage += rng.nextInt(8) + 1;
                    if(check) {
                        damage += 5;
                    }
                    if (attackRoll >= critChance || (check && attackRoll == 20 + 5)) { //Changed to use new variables
                        damage *= 2;
                ...
                check = false;
                if (enemyHP <= 0) {
                    System.out.println("Enemy died in " + attack + " turns");
                    scan.close();
                    return;
                }
            }
